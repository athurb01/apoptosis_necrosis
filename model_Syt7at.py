...
##### Reaction List #####
#EARM
create_monomers(['L','R','XIAP','Bcl2','flip','BAR','Mcl','DISC','C8','C8a','C3','C3a','C3i','PARP','cPARP','C6','C6a','Bid','tBid','Bax','aBax','MBax','Bax2','Bax4','MOM','MOMP','mCytoC','aCytoC','cCytoC','mSmac','aSmac','cSmac','Apaf','aApaf','C9','Apop','ATP','ADP'])

act3(L,R,DISC,4e-7,1e-3,1e-5)
bind(flip,DISC,1e-6,1e-3)
act2(DISC,C8,C8a,1e-6,1e-3,1)
bind(C8a,BAR,1e-6,1e-3)
act4(C8a,C3,C3a,1e-7,1e-3,1e-8)
act4(C3a,C6,C6a,1e-6,1e-3,1e-8)
act4(C3a,PARP,cPARP,1e-6,1e-2,1e-8)
act4(C6a,C8,C8a,1e-6,1e-3,1e-8)
act2(XIAP,C3a,C3i,2e-6,1e-3,1e-1)
act4(C8a,Bid,tBid,1e-7,1e-3,1e-8)
bind(tBid,Mcl,1e-6,1e-3)
act2(tBid,Bax,aBax,1e-7,1e-3,1)
migrate2(aBax,MBax,1e-2,1e-2)
...
migrate2(iCa,eCa,0,0)
act1(SERCA,iCa,eCa,1e-2)
...
act2(PKA,MIM,MIMp,1e-6,1e-1,1e-1)
