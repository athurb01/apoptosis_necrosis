...
def t_MOMP(MOMP_cutoff = 100000.0):
...
def create_phase():
    ...
    for i in A:
        ...
        X.append(s.yobs['o_MIMP'][-1] / 100.0)
        Y.append(100 * (1 - s.yobs['o_ATP'][-1] / 100000000.0))
        Z.append(s.yobs['o_iNa'][-1] / 100000.0)
