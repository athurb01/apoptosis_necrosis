# -*- coding: utf-8 -*-
"""
Created on Wed May 23 08:23:15 2018
...
Observable('t_LXA4',LXA4(b=None))
Expression('IKKp_kf_LXA4', 1/(IKKp_kf+inh_LXA4*t_LXA4))
Rule('bind_IKKp_IkB_LXA4', IKKp(b=None) + IkB(l='c',s='u') | 
        IKKp(b=1)%IkB(l='c',s=('u',1)), IKKp_kf_LXA4, kinase_kr_generic) #replaces rule 92, note IkB(b) is not defined)
